                ...
                <div class="col-lg-12">
                    <form action="{{ route('buku.update', $buku->id_buku) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            <div class="card mb-4">
                                <div class="card-body">
                                    <h2 class="text-center"><strong>Ubah Buku</strong></h2>
                                    ...
                                    <div class="row">
                                        <div class="col my-3">
                                            ...
                                            <input type="text" class="form-control @error('judul_buku') is-invalid @enderror" id="judul_buku" name="judul_buku"
                                                value="{{ old('judul_buku', $buku->judul_buku) }}" placeholder="Masukkan Judul Buku" autocomplete="off">
                                            @error('judul_buku')
                                    ...
                                    <div class="row">
                                        <div class="col my-3">
                                            ...
                                            <input type="text" class="form-control @error('penulis_buku') is-invalid @enderror" id="penulis_buku" name="penulis_buku"
                                                value="{{ old('penulis_buku', $buku->penulis_buku) }}" placeholder="Masukkan Penulis Buku" autocomplete="off">
                                            @error('penulis_buku')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col my-3">
                                            ...
                                            <input type="text" class="form-control @error('penerbit_buku') is-invalid @enderror" id="penerbit_buku" name="penerbit_buku"
                                                value="{{ old('penerbit_buku', $buku->penerbit_buku) }}" placeholder="Masukkan Penerbit Buku" autocomplete="off">
                                            @error('penerbit_buku')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col my-3">
                                            ...
                                            <input class="form-control @error('tahunterbit_buku') is-invalid @enderror"
                                                name="tahunterbit_buku" type="number" value="{{ old('tahunterbit_buku', $buku->tahunterbit_buku) }}"
                                    ...
                                    <div class="row">
                                        <div class="col my-3">
                                            ...
                                            >{{ old('sinopsis_buku', $buku->sinopsis_buku) }}</textarea>
                                            @error('sinopsis_buku')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col my-3">
                                            ...
                                            <div class="upload-container">
                                                ...
                                                <div class="text-center mt-3">
                                                    ...
                                                    @if ($buku->sampul_buku)
                                                        <img src="{{ asset('storage/' . $buku->sampul_buku) }}" alt="Sampul Buku"
